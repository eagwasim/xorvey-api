...
fun UserRegistrationRequest.toUser() = Access(null, this.firstName, this.lastName, this.email, null, false, this.password, Account(this.accountName, this.accountType))