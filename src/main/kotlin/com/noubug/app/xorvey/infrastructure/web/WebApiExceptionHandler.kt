...
class BaseControllerAdvice : ResponseEntityExceptionHandler() {
    ...
    fun handleInputParameterException(exception: InputParameterException): ResponseEntity<ControllerResponseJSON<Nothing>> {
        return ResponseEntity(ControllerResponseJSON(exception.message!!, null), HttpStatus.BAD_REQUEST)
    }
